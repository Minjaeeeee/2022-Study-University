...
void input_clothes()
 {
   FILE* fp = fopen("D:\\temp\\clothes_info.txt", "r");
   char line[150];
   char* ptr;
   int word_cnt;
...
void input_customer()
 {
   FILE* c_fp = fopen("D:\\temp\\customer_info.txt", "r");
   char line[150];
   char* ptr;
   int word_cnt;
...
void new_customer()
{
   FILE* c_fp = fopen("D:\\temp\\customer_info.txt", "a");
...
void new_add()
{
   FILE* fp = fopen("D:\\temp\\clothes_info.txt", "a");
